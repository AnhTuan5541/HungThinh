...
namespace HungThinh.Controllers
{
    public class ApplicationController : Controller
    {
        ...
        [HttpPost]
        [Authorize]
        public IActionResult SignApplication(int signFlowId, int idType, int valueSign, string comment, string userIdForward, string subSystem, string fileUrl, string fileName, string timeSpan)
        {
            string functionName = ControllerContext.ActionDescriptor.ControllerName + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name;
            string userid = User.FindFirstValue(ClaimTypes.Name);
            try
        ...
        [HttpGet]
        [Authorize]
        public IActionResult GetApplicationByIdCard(string idCard, int valueSign)
        {
            string functionName = ControllerContext.ActionDescriptor.ControllerName + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name;
            string userid = User.FindFirstValue(ClaimTypes.Name);
            try
        ...
        [HttpGet]
        [Authorize]
        public IActionResult GetApplicationSupportByIdCard(string idCard, int valueSign)
        {
            string functionName = ControllerContext.ActionDescriptor.ControllerName + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name;
            string userid = User.FindFirstValue(ClaimTypes.Name);
            try
            {
                using var connection = new SqlConnection(_connection.DefaultConnection);
                using var command = new SqlCommand("GetApplicationSupportByIdCard", connection) { CommandType = CommandType.StoredProcedure };
                ...
                CommonFunction.LogInfo(_connection.DefaultConnection, userid, "Get application support successfully", CommonFunction.SUCCESS, functionName);
                var response = new CommonResponse<Dictionary<string, object>>
                {
                    StatusCode = CommonFunction.SUCCESS,
                    Message = "Get application support successfully",
                    Data = data,
                    size = data.Count
                };
                return Ok(response);
        ...
        [HttpGet]
        [Authorize]
        public IActionResult CheckSequence1Sign(string applicationNo)
        {
            string functionName = ControllerContext.ActionDescriptor.ControllerName + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name;
            string userid = User.FindFirstValue(ClaimTypes.Name);
            try
            {
                using var connection = new SqlConnection(_connection.DefaultConnection);
                using var command = new SqlCommand("CheckSequence1Sign", connection) { CommandType = CommandType.StoredProcedure };
        ...
        [HttpPost]
        [Authorize]
        public IActionResult DeleteApplication(string applicationNo)
        {
            string functionName = ControllerContext.ActionDescriptor.ControllerName + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name;
            string userid = User.FindFirstValue(ClaimTypes.Name);
            try
            {
                using var connection = new SqlConnection(_connection.DefaultConnection);
                using var command = new SqlCommand("DeleteApplication", connection) { CommandType = CommandType.StoredProcedure };
                ...
                CommonFunction.LogInfo(_connection.DefaultConnection, userid, "Cancel application successfully", CommonFunction.SUCCESS, functionName);
                var response = new CommonResponse<Dictionary<string, object>>
                {
                    StatusCode = CommonFunction.SUCCESS,
        ...
        [HttpGet]
        [Authorize]
        public IActionResult GetApplicationByValueSign(int valueSign, string timeSpan)
        {
            string functionName = ControllerContext.ActionDescriptor.ControllerName + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name;
            string userid = User.FindFirstValue(ClaimTypes.Name);
            try
